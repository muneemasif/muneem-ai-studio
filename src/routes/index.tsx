...
import { createThread, useThreads, uid, ensureThreadExists } from "@/lib/history";
...
function Index() {
  ...
  useEffect(() => {
    ...
    // Route to the most recent thread if any exist, otherwise create one.
    if (threads.length > 0) {
    ...
    // run once on mount; navigation replaces this page
